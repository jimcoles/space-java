 ...
 * release of the Space language and should not change.
 *
 *   Question:  This is a neat trick, but it is useful to have these data available.
 *
 */
public class TestMetaMetaSpaces {
